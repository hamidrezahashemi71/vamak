  ...
  return (
    <div className='absolute left-0 top-0 flex justify-between items-center w-[84.5vw] h-28 px-40 py-7 bg-white'>
      <div className='flex flex-col'>
        <p className='text-black text-2xl'>حمیدرضا هاشمی</p>
        <p className='text-textGray text-xl'>به سامانه صندوق وامک خوش آمدید</p>
      </div>
      <div className='flex gap-8'>
        ...
        <p className='text-xl '>تاریخ: 15 خرداد 1400</p>
      </div>
    </div>
  );
};
